...
.dark .loading-container, .dark .error-message {
  color: #93c5fd;
}

.dark .yoga-header-section {
  color: #93c5fd;
}

.dark .yoga-header-section h1 {
  color: #dbeafe;
}
...
.dark .asana-description {
  color: #cbd5e0;
}

.dark .pose-count, .dark .benefits {
...
.dark .asana-instructions {
  color: #cbd5e0;
}

.dark .speed-control label {
  color: #93c5fd;
}
