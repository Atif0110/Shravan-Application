...
onMounted(() => {
  username.value = localStorage.getItem('userName') || 'Demo User';
  if (auth_store.userDetails) {
    try {
      // username.value = JSON.parse(auth_store.username) || "Demo User";
...
git 
    <section class="welcome-section">
      ...
      <div class="welcome-image">
        <img src="../assets/avatars/default.png" alt="Senior Care" class="care-image">
      </div>
    </section>
    ...
    <section class="features-section">
      ...
      <div class="card-container">
        ...
        <div class="feature-card" @click="goToFeature('/animation')">
          <div class="card-icon">🧘‍♀️</div>
          <h3>Age-Friendly Yoga</h3>
          <p>Gentle exercises suitable for seniors</p>
        </div>

        <div class="feature-card" @click="goToFeature('/pharmacy-finder')">
          <div class="card-icon">🏪</div>
        ...
        <div class="feature-card" @click="goToFeature('/doctor-finder')">
          <div class="card-icon">👨‍⚕️</div>
          <h3>Doctor Finder</h3>
          <p>Find the best doctors in your locality</p>
        </div>

        <div class="feature-card" @click="goToFeature('/personal-chatbot')">
          <div class="card-icon">🤖</div>
          <h3>Personal Chatbot </h3>
          <p>Get personalized assistance and support</p>
        </div>
