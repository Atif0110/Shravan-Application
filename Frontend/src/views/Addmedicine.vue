...
async function addReminder() {
  try {
    ...
    // Field names must match what Backend/routes_reminders.py expects:
    // medicine_name, time_of_day, frequency (dosage is optional).
    const reminderData = {
      medicine_name: newReminder.value.medicineName,
